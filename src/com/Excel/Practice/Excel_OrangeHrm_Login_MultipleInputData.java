...
public class Excel_OrangeHrm_Login_MultipleInputData {
...
//Writing Actual LoginPanel Text into Excel File					
					...
					//FileOutputStream testresult_1_1= new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\OrangeHrm_Login_TestResultFile.xlsx");
		...
		if(actual_loginPanelText.contains(expected_LoginPanel_Text))
		{
					...
					//FileOutputStream testresult_1_2 = new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\OrangeHrm_Login_TestResultFile.xlsx");
...
//Writing OHRM Title into Excel
					...
					//FileOutputStream testresult_1_4 = new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\OrangeHrm_Login_TestResultFile.xlsx");
...
//Result Status				
		if(actual_LogInPage_Title.equals(expected_LogInPage_Title))
		{
					...
					//FileOutputStream testresult_1_5 = new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\OrangeHrm_Login_TestResultFile.xlsx");
...
System.out.println("The expected OrangeHrm Url address from Excel is:- "+expectedLoginpageUrlAddress);		
		String actualLoginPageUrlAddress=driver.getCurrentUrl();
					...
					rc_1_7.setCellValue(actualLoginPageUrlAddress);
					//FileOutputStream testresult_1_7 = new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\OrangeHrm_Login_TestResultFile.xlsx");
	...
	if(actualLoginPageUrlAddress.contains(expectedLoginpageUrlAddress))	
	{
					...
					//FileOutputStream testresult_1_8 = new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\OrangeHrm_Login_TestResultFile.xlsx");
					//workBook.write(testresult_1_8);
...
//System.out.println(RC_1_12);		
		...
		if(actual_Admin_Link_Text.equals(RC_1_12))
		{
			...
			//FileOutputStream testresult_1_14= new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Start\\1LogInTest.xlsx");
...
System.out.println("Failed to Log Out:- FAIL");			
		...
		FileOutputStream login_Logout_TestResult = new FileOutputStream("D:\\Jaava\\Eclipse Workspace\\Selenium_with_Java\\src\\com\\Excel\\Result\\Input\\Login_Logout_TestResult.xlsx");
		...
		System.out.println("Active Cell Count in a row is: "+row1.getLastCellNum());		
			...
			{	
				...
				for(int cellindex=9; cellindex<=10;cellindex++)
				{
					if(cellindex==9)//==userName
					{
						Cell currentCell=currentRow.getCell(cellindex);
						String userNameInputData = currentCell.getStringCellValue();
						WebElement userNameElement=driver.findElement(By.id("txtUsername"));
						userNameElement.sendKeys(userNameInputData);
						String username=userNameElement.getAttribute("value");
						System.out.println(username);
					}
					if(cellindex==10)//==password
					{
						Cell currentCell=currentRow.getCell(cellindex);
						String passwordInputData=currentCell.getStringCellValue();
						
						WebElement passwordElement=driver.findElement(By.id("txtPassword"));
						passwordElement.sendKeys(passwordInputData);
						...
						Cell rc_1_0=row1.getCell(0);
						String expected_LoginPanel_Text=rc_1_0.getStringCellValue();
						if(expected_LoginPanel_Text.equals(expected_LoginPanel_Text))
						{	WebElement loginPanel=driver.findElement(By.id("logInPanelHeading"));
						String actual_loginPanelText=loginPanel.getText();
							System.out.println("Fail to login -- invalid Credentials");
						}
						if(expected_LoginPanel_Text.equals(actual_loginPanelText)) {
							System.out.println("Successfully navigated");
						}
						
					}
					
					//userName.add(currentCell.getStringCellValue());
					
					//passworddata must be stored in a variable and should be printed on
					//the application in another loop for username and password
