...
public class RadioButtonsBlocksTest {
	WebDriver driver;
...
System.out.println("RadioButton"+buttonIndex+" is not displayed");						
		...
		WebElement radioButtonsTable=driver.findElement(By.xpath("/html/body/div[2]/table[9]/tbody/tr/td[4]/table/tbody/tr/td/div/span/form/table[3]/tbody/tr/td/table/tbody/tr"));

		By radioInput=By.tagName("input");
		List<WebElement>radioButtons=radioButtonsTable.findElements(radioInput);
		int radioButtonsCount=radioButtons.size();
	//	<input type="radio" name="group1" value="Butter" checked="">
		
//WebElement test=driver.findElement(By.xpath("/html/body/div[2]/table[9]/tbody/tr/td[4]/table/tbody/tr/td/div/span/form/table[3]/tbody/tr/td/table/tbody/tr/td/input[3]"));
	//		System.out.println(test.getAttribute("checked"));
		
		
System.out.println("No.of Radio Buttons:- "+radioButtonsCount);		
		for(int radioButtonIndex = 0; radioButtonIndex<radioButtons.size(); radioButtonIndex++)
		{
					// Getting to every radio button
			radioButtons.get(radioButtonIndex).click();
		Thread.sleep(999);		
		
			for(int uncheckValidationindex = 0; uncheckValidationindex<radioButtons.size();uncheckValidationindex++)
			{
				
				String radioButtonName=radioButtons.get(uncheckValidationindex).getAttribute("value");
				
			
				String statusOfRadioButton=radioButtons.get(radioButtonIndex).getAttribute("checked");
				System.out.println(radioButtonName+"--- "+statusOfRadioButton);	
